...
#import "SystranJSONResponseSerializer.h"
#import "SystranJSONRequestSerializer.h"
 ...
 */
extern NSString *const SystranResponseObjectErrorKey;

/**
 * Log debug message macro
 */
#define SystranDebugLog(format, ...) [SystranApiClient debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];

@interface SystranApiClient : AFHTTPRequestOperationManager

@property(nonatomic, assign) NSURLRequestCachePolicy cachePolicy;
@property(nonatomic, assign) NSTimeInterval timeoutInterval;
@property(nonatomic, readonly) NSOperationQueue* queue;

/// In order to ensure the HTTPResponseHeaders are correct, it is recommended to initialize one SystranApiClient instance per thread.
